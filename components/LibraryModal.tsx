...
/**
 * Decodes raw PCM audio data bytes returned by the Gemini API.
 * Follows the guidelines for decoding raw streams.
 */
                    ...
                    <div key={item.id} className="bg-white dark:bg-[#1A1D24] rounded-[2rem] p-6 shadow-sm border-2 border-stone-100 dark:border-white/5 hover:border-[#AF86FF] hover:shadow-xl transition-all group relative">
                       ...
                       <div className="flex justify-between items-start mb-4">
                          <img 
                            src={lang?.flag} 
                            alt={lang?.name}
                            className="w-10 h-10 rounded-full object-cover shadow-md border-2 border-white dark:border-stone-800"
                          />
